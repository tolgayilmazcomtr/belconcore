    ...
    return (
        <header className="h-[52px] flex items-center justify-between px-3 bg-primary text-white shadow-sm shrink-0 gap-2 overflow-hidden">
            ...
            <div className="flex items-center gap-2 min-w-0 flex-1">
                ...
                {/* Proje seçici - her zaman görünür */}
            ...
            <div className="flex items-center gap-1 shrink-0">
                ...
                <button className="hidden md:flex p-1.5 rounded hover:bg-white/20 transition-colors">
                    <Settings size={18} />
                </button>

                <div className="flex items-center gap-1.5 cursor-pointer hover:bg-white/20 p-1 pl-1.5 pr-2 rounded transition-colors ml-1 border-l border-white/10 relative group">
                    <UserCircle size={24} className="text-white/80 shrink-0" />
                    ...
                    {/* Dropdown */}
                    <div className="absolute top-[100%] right-0 mt-2 bg-white text-foreground rounded-md shadow-lg border border-border w-44 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity z-50">
                        <button
